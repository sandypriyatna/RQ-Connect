...
class CheckoutActivity : AppCompatActivity() {
    ...
    private fun getCheckoutData() {
        ...
        tv_total_payment.text = prefManager.spSppTotal
        ...
        if (prefManager.spDeposit.isNullOrEmpty() && prefManager.spInfaq.isNullOrEmpty()) {
            tv_tabungan.text = "0"
            tv_infaq.text = "0"
            prefManager.spDeposit = "0"
            prefManager.spInfaq = "0"
        } else if (prefManager.spDeposit.isNullOrEmpty()) {
            tv_tabungan.text = "0"
            prefManager.spDeposit = "0"
            tv_infaq.text = prefManager.spInfaq
        } else if (prefManager.spInfaq.isNullOrEmpty()) {
            tv_tabungan.text = prefManager.spDeposit
            tv_infaq.text = "0"
            prefManager.spInfaq = "0"
        } else {
